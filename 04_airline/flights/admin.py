...
class FlightAdmin(admin.ModelAdmin):
    ...
    # We can say, in list_display, when you list all the flights and display them all to me, show me the id, origin, 
...
class PassengerAdmin(admin.ModelAdmin):
    ...
    # Note that we must add the comma ',' after "flights", which means the value of 'filter_horizontal' must be a list or tuple.
