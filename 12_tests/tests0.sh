...
# These files require a ".sh" extension, so our file will be called "tests0.sh". Each of the lines below consists of three parts:
...
# Enter the current directory and run these commands by running "./tests0.sh" in the terminal, giving us this result:
